...
to continue to the next page, however my program did not require to check that the email paramter was in an email format, which means any input was able to be inserted into that certain parameter.
